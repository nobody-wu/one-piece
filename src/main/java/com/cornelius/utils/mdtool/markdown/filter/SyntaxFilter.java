package com.cornelius.utils.mdtool.markdown.filter;
...
public abstract class SyntaxFilter {
	...
	private com.youbenzi.mdtool.markdown.filter.SyntaxFilter nextFilter = null;

	public abstract List<TextOrBlock> invoke(List<String> lines);

	public SyntaxFilter(com.youbenzi.mdtool.markdown.filter.SyntaxFilter nextFilter) {
		super();
